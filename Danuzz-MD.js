...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("Danuzz-MD")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 Danuzz-MD is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 **© Danuzz-MD 💚 Connected Successfully!** ✅ 
          
          --- **🎉 Welcome to © Danuzz-MD 💚!** 🎉 
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["94762294745@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          forwardedNewsletterMessageInfo: {
            newsletterJid: "120363299978149557@newsletter",
            newsletterName: "© Danuzz-MD 💚",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "© Danuzz-MD 💚",
            body: " ©𝐌𝐑 𝐃𝐀𝐍𝐔𝐙𝐙 𝐎𝐅𝐒 💚",
            mediaType: 1,
            sourceUrl: "https://github.com/Danidudanesh",
            thumbnailUrl:
              "https://github.com/Danidudanesh/Danuzz/blob/main/LOGOS/ChatGPT%20Image%20Aug%2022,%202025,%2011_32_57%20AM.png?raw=true", // This should match the image URL provided above
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("hey I am alive, Danuzz-MD Is started✅");
});
app.listen(port, () =>
